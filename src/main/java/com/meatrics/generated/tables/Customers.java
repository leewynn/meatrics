...
public class Customers extends TableImpl<CustomersRecord> {
    ...
    /**
     * The column <code>public.customers.customer_rating</code>.
     */
    public final TableField<CustomersRecord, String> CUSTOMER_RATING = createField(DSL.name("customer_rating"), SQLDataType.VARCHAR(50), this, "");
